            ...
            ->children()
                ...
                ->arrayNode('templating')
                    ...
                    ->children()
                        ->arrayNode('uri_query')
                            ->addDefaultsIfNotSet()
                            ->info('Control the uri query behavior of the sources and inputs provided to the templating extension and helper components.')
                            ->children()
                                ->booleanNode('origin_remove')
                                    ->defaultFalse()
                                    ->info('Remove the origin (input) uri query before resolving input.')
                                ->end()
                                ->booleanNode('output_append')
                                    ->defaultTrue()
                                    ->info('Append the origin uri query to the output uri before returning the resolved result.')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
