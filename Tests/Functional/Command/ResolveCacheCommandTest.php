...
class ResolveCacheCommandTest extends AbstractCommandTestCase
{
    ...
    public function testScriptReadableOption()
    {
        ...
        $output = $this->executeResolveCacheCommand($images, $filters, array('--machine-readable' => false));
    ...
    /**
     * @return ResolveCacheCommand|object
     */
    private function getResolveCacheCommand(): ResolveCacheCommand
    {
        return $this->getService('liip_imagine.command.cache_resolve');
    }
